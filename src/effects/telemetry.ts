// Telemetry strip (§7.3): live IST clock, coordinates cycling between the labs, and a
// fake-but-plausible SIGNAL meter. Plain text ticks, no motion to disable under
